...
#if !defined(CONFIG_MTK_TC1_FEATURE) //Added Modification for ALPS01471345, due to the MTP may not be the first enum func, w_index of ctrl request may not be 0            
                && w_index == 0
#endif
				&& w_value == 0) {
