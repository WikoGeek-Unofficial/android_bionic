...
//sat
#define		SP0A19_P0_0xd3 0x8c//0x88
#define		SP0A19_P0_0xd4 0x88//0x80
#define		SP0A19_P0_0xd6 0x78//0x70
#define		SP0A19_P0_0xd7 0x78//0x60
//heq
#define		SP0A19_P0_0xdd 0x72//0x70
#define		SP0A19_P0_0xde 0x98
...
void SP0A19NightMode(kal_bool bEnable)
{
   ...
   SP0A19_CurrentStatus.iNightMode = bEnable;
	...
	{ 
		...
		{  
			if(sp0a19_isBanding== 0)
			{
				...
				SP0A19_write_cmos_sensor(0xfd,0x00);
				SP0A19_write_cmos_sensor(0x03,0x00);
				SP0A19_write_cmos_sensor(0x04,0x84);
				SP0A19_write_cmos_sensor(0x06,0x00);
				SP0A19_write_cmos_sensor(0x09,0x08);
				SP0A19_write_cmos_sensor(0x0a,0x39);
				SP0A19_write_cmos_sensor(0xf0,0x2c);
				SP0A19_write_cmos_sensor(0xf1,0x00);
				SP0A19_write_cmos_sensor(0xfd,0x01);
				SP0A19_write_cmos_sensor(0x90,0x12);
				SP0A19_write_cmos_sensor(0x92,0x01);
				SP0A19_write_cmos_sensor(0x98,0x2c);
				SP0A19_write_cmos_sensor(0x99,0x00);
				SP0A19_write_cmos_sensor(0x9a,0x01);
				SP0A19_write_cmos_sensor(0x9b,0x00);
				//Status
				SP0A19_write_cmos_sensor(0xfd,0x01);
				SP0A19_write_cmos_sensor(0xce,0x18);
				SP0A19_write_cmos_sensor(0xcf,0x03);
				SP0A19_write_cmos_sensor(0xd0,0x18);
			...
			else if(sp0a19_isBanding== 1)
			{
				...
				SP0A19_write_cmos_sensor(0xfd,0x00);
				SP0A19_write_cmos_sensor(0x03,0x00);
				SP0A19_write_cmos_sensor(0x04,0x6f);
				SP0A19_write_cmos_sensor(0x06,0x00);
				SP0A19_write_cmos_sensor(0x09,0x08);
				SP0A19_write_cmos_sensor(0x0a,0x1e);
				SP0A19_write_cmos_sensor(0xf0,0x25);
				SP0A19_write_cmos_sensor(0xf1,0x00);
				SP0A19_write_cmos_sensor(0xfd,0x01);
				SP0A19_write_cmos_sensor(0x90,0x15);
				SP0A19_write_cmos_sensor(0x92,0x01);
				SP0A19_write_cmos_sensor(0x98,0x25);
				SP0A19_write_cmos_sensor(0x99,0x00);
				SP0A19_write_cmos_sensor(0x9a,0x01);
				SP0A19_write_cmos_sensor(0x9b,0x00);
				//Status
				SP0A19_write_cmos_sensor(0xfd,0x01);
				SP0A19_write_cmos_sensor(0xce,0x09);
				SP0A19_write_cmos_sensor(0xcf,0x03);
				SP0A19_write_cmos_sensor(0xd0,0x09);
				SP0A19_write_cmos_sensor(0xd1,0x03);
				SP0A19_write_cmos_sensor(0xfd,0x00);
				#endif
			}
	...
	else    // daylight mode
	{
		...
		SP0A19_write_cmos_sensor(0xfd,0x00);
		SP0A19_write_cmos_sensor(0xb2,0x1c);//20
		SP0A19_write_cmos_sensor(0xb3,0x1f);
...
{  
	...
	SP0A19_write_cmos_sensor(0xfb,0x31); // 0x33
	SP0A19_write_cmos_sensor(0x1f,0x08);//10
	...
	//lsc  for st 
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0x35,0x14);//16//16
	SP0A19_write_cmos_sensor(0x36,0x15);//17//17
	SP0A19_write_cmos_sensor(0x37,0x15);//17//15
	SP0A19_write_cmos_sensor(0x38,0x11);//13//14
	SP0A19_write_cmos_sensor(0x39,0x15);//17//17
	SP0A19_write_cmos_sensor(0x3a,0x13);//15//15
	SP0A19_write_cmos_sensor(0x3b,0x12);//14//14
	SP0A19_write_cmos_sensor(0x3c,0x0f);//11//11
	SP0A19_write_cmos_sensor(0x3d,0x15);//17//17
	SP0A19_write_cmos_sensor(0x3e,0x14);//16//16
	SP0A19_write_cmos_sensor(0x3f,0x13);//15//15
	SP0A19_write_cmos_sensor(0x40,0x14);//16//16
	SP0A19_write_cmos_sensor(0x41,0x02);//00
	SP0A19_write_cmos_sensor(0x42,0x02);//02
	SP0A19_write_cmos_sensor(0x43,0x05);//01
	SP0A19_write_cmos_sensor(0x44,0x03);//06
	SP0A19_write_cmos_sensor(0x45,0x00);//00
	SP0A19_write_cmos_sensor(0x46,0x00);//00
	SP0A19_write_cmos_sensor(0x47,0x04);//04
	SP0A19_write_cmos_sensor(0x48,0x08);//08
	SP0A19_write_cmos_sensor(0x49,0x00);//00
	SP0A19_write_cmos_sensor(0x4a,0x00);//00
	SP0A19_write_cmos_sensor(0x4b,0x03);//03
	SP0A19_write_cmos_sensor(0x4c,0x00);//00
	SP0A19_write_cmos_sensor(0xfd,0x00);
	...
	//d65
	SP0A19_write_cmos_sensor(0x65,0xc2);//cd//b4
	SP0A19_write_cmos_sensor(0x66,0xeb);//f6//da
	SP0A19_write_cmos_sensor(0x67,0x6a);//67//6f
	SP0A19_write_cmos_sensor(0x68,0x92);//89//91
	//indoor
	SP0A19_write_cmos_sensor(0x69,0xb7);//83
	SP0A19_write_cmos_sensor(0x6a,0xdf);//a6
	SP0A19_write_cmos_sensor(0x6b,0x90);//a6
	SP0A19_write_cmos_sensor(0x6c,0xba);//d5
	//f 
	SP0A19_write_cmos_sensor(0x61,0x75);//6e//70//7d//70
	SP0A19_write_cmos_sensor(0x62,0x9a);//98//9b//a4//9a
	SP0A19_write_cmos_sensor(0x63,0xc8);//c6//c0//c1
	SP0A19_write_cmos_sensor(0x64,0xec);//e7//e0//e6
	//cwf
	SP0A19_write_cmos_sensor(0x6d,0xa0);//a8//ad//98
	SP0A19_write_cmos_sensor(0x6e,0xca);//d4//cf//be
	SP0A19_write_cmos_sensor(0x6f,0xb0);//b1//a3//a4
	SP0A19_write_cmos_sensor(0x70,0xda);//d8//cb//cf
	...
	SP0A19_write_cmos_sensor(0xec,0x33);	//sharp_fac_neg_outdoor
	SP0A19_write_cmos_sensor(0xe9,0x20);	//sharp_fac_pos_nr	  // 0x35
	SP0A19_write_cmos_sensor(0xed,0x33);	//sharp_fac_neg_nr
	SP0A19_write_cmos_sensor(0xea,0x20);	//sharp_fac_pos_dummy	// 0x30
	SP0A19_write_cmos_sensor(0xef,0x2e);	//sharp_fac_neg_dummy	// 0x20
	SP0A19_write_cmos_sensor(0xeb,0x11);	//sharp_fac_pos_low
	SP0A19_write_cmos_sensor(0xf0,0x20);	//sharp_fac_neg_low 
	
	//CCM
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0xa0,0x80);
	SP0A19_write_cmos_sensor(0xa1,0xf4);
	SP0A19_write_cmos_sensor(0xa2,0x0c);
	SP0A19_write_cmos_sensor(0xa3,0xf3);
	SP0A19_write_cmos_sensor(0xa4,0x8e);
	SP0A19_write_cmos_sensor(0xa5,0x0 );
	SP0A19_write_cmos_sensor(0xa6,0xe6);
	SP0A19_write_cmos_sensor(0xa7,0x00);
	SP0A19_write_cmos_sensor(0xa8,0x9a);
	SP0A19_write_cmos_sensor(0xa9,0x0c);
	SP0A19_write_cmos_sensor(0xaa,0x3 );
	SP0A19_write_cmos_sensor(0xab,0x3 );
	SP0A19_write_cmos_sensor(0xfd,0x00);
	
	//gamma  
	SP0A19_write_cmos_sensor(0xfd,0x00);
	SP0A19_write_cmos_sensor(0x8b,0x00);
	SP0A19_write_cmos_sensor(0x8c,0x0e);
	SP0A19_write_cmos_sensor(0x8d,0x1a);
	SP0A19_write_cmos_sensor(0x8e,0x2c);
	SP0A19_write_cmos_sensor(0x8f,0x48);
	SP0A19_write_cmos_sensor(0x90,0x60);
	SP0A19_write_cmos_sensor(0x91,0x77);
	SP0A19_write_cmos_sensor(0x92,0x88);
	SP0A19_write_cmos_sensor(0x93,0x97);
	SP0A19_write_cmos_sensor(0x94,0xa3);
	SP0A19_write_cmos_sensor(0x95,0xaf);
	SP0A19_write_cmos_sensor(0x96,0xba);
	SP0A19_write_cmos_sensor(0x97,0xc6);
	SP0A19_write_cmos_sensor(0x98,0xd1);
	SP0A19_write_cmos_sensor(0x99,0xda);
	SP0A19_write_cmos_sensor(0x9a,0xe3);
	SP0A19_write_cmos_sensor(0x9b,0xec);
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0x8d,0xf5);
	SP0A19_write_cmos_sensor(0x8e,0xfd);
	SP0A19_write_cmos_sensor(0xfd,0x00);
	//rpc
	SP0A19_write_cmos_sensor(0xfd,0x00); 
	...
	SP0A19_write_cmos_sensor(0x4d,0x60);
	...
	SP0A19_write_cmos_sensor(0xb4,0x50); //black_vt  // 0x20
	SP0A19_write_cmos_sensor(0xb5,0x65); //white_vt
	...
	SP0A19_write_cmos_sensor(0xd3,SP0A19_P0_0xd3); //0x78
	SP0A19_write_cmos_sensor(0xd4,SP0A19_P0_0xd4); //0x78
	SP0A19_write_cmos_sensor(0xd6,SP0A19_P0_0xd6); //0x78	   (0xd7,0x60); //0x78
	SP0A19_write_cmos_sensor(0xd7,SP0A19_P0_0xd7);
	
	//HEQ
	SP0A19_write_cmos_sensor(0xfd,0x00); 
	SP0A19_write_cmos_sensor(0xdc,0x00); 
	SP0A19_write_cmos_sensor(0xdd,SP0A19_P0_0xdd); //0x80 0813	// 0x78
	SP0A19_write_cmos_sensor(0xde,SP0A19_P0_0xde); //80  0x88  0813
...
void SP0A19_Sensor_Init(void)
{
	...
	//lsc  for st 
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0x35,0x28);//16//16
	SP0A19_write_cmos_sensor(0x36,0x26);//17//17
	SP0A19_write_cmos_sensor(0x37,0x25);//17//15
	SP0A19_write_cmos_sensor(0x38,0x24);//13//14
	SP0A19_write_cmos_sensor(0x39,0x28);//17//17
	SP0A19_write_cmos_sensor(0x3a,0x28);//15//15
	SP0A19_write_cmos_sensor(0x3b,0x23);//14//14
	SP0A19_write_cmos_sensor(0x3c,0x27);//11//11
	SP0A19_write_cmos_sensor(0x3d,0x28);//17//17
	SP0A19_write_cmos_sensor(0x3e,0x26);//16//16
	SP0A19_write_cmos_sensor(0x3f,0x25);//15//15
	SP0A19_write_cmos_sensor(0x40,0x27);//16//16
	SP0A19_write_cmos_sensor(0x41,0x03);//00
	SP0A19_write_cmos_sensor(0x42,0x04);//02
	SP0A19_write_cmos_sensor(0x43,0x06);//01
	SP0A19_write_cmos_sensor(0x44,0x00);//06
	SP0A19_write_cmos_sensor(0x45,0x01);//00
	SP0A19_write_cmos_sensor(0x46,0x00);//00
	SP0A19_write_cmos_sensor(0x47,0x00);//04
	SP0A19_write_cmos_sensor(0x48,0x01);//08
	SP0A19_write_cmos_sensor(0x49,0xfd);//00
	SP0A19_write_cmos_sensor(0x4a,0x00);//00
	SP0A19_write_cmos_sensor(0x4b,0x06);//03
	SP0A19_write_cmos_sensor(0x4c,0xfd);//00
	SP0A19_write_cmos_sensor(0xfd,0x00);
	...
	SP0A19_write_cmos_sensor(0x1b,0x80); 
	//d65
	SP0A19_write_cmos_sensor(0x65,0xc3);//cd//b4
	SP0A19_write_cmos_sensor(0x66,0xe9);//f6//da
	SP0A19_write_cmos_sensor(0x67,0x72);//67//6f
	SP0A19_write_cmos_sensor(0x68,0x94);//89//91
	//indoor
	SP0A19_write_cmos_sensor(0x69,0xb7);//83
	SP0A19_write_cmos_sensor(0x6a,0xdf);//a6
	SP0A19_write_cmos_sensor(0x6b,0x90);//a6
	SP0A19_write_cmos_sensor(0x6c,0xba);//d5
	//f 
	SP0A19_write_cmos_sensor(0x61,0x69);//6e//70//7d//70
	SP0A19_write_cmos_sensor(0x62,0x90);//98//9b//a4//9a
	SP0A19_write_cmos_sensor(0x63,0xc4);//c6//c0//c1
	SP0A19_write_cmos_sensor(0x64,0xe8);//e7//e0//e6
	//cwf
	SP0A19_write_cmos_sensor(0x6d,0xa6);//a8//ad//98
	SP0A19_write_cmos_sensor(0x6e,0xcd);//d4//cf//be
	SP0A19_write_cmos_sensor(0x6f,0xac);//b1//a3//a4
	SP0A19_write_cmos_sensor(0x70,0xd5);//d8//cb//cf
	...
	SP0A19_write_cmos_sensor(0x58,0x0a);
	SP0A19_write_cmos_sensor(0x56,0x10);
	SP0A19_write_cmos_sensor(0x59,0x16);
	
	SP0A19_write_cmos_sensor(0x89,0x08);
	SP0A19_write_cmos_sensor(0x8a,0x0a);
	SP0A19_write_cmos_sensor(0x9c,0x10);
	SP0A19_write_cmos_sensor(0x9d,0x16);
	
	SP0A19_write_cmos_sensor(0x81,0xe0);
	SP0A19_write_cmos_sensor(0x82,0x80);
	SP0A19_write_cmos_sensor(0x83,0x50);
	SP0A19_write_cmos_sensor(0x84,0x16);
	
	SP0A19_write_cmos_sensor(0x85,0xe0);
	SP0A19_write_cmos_sensor(0x86,0x80);
	SP0A19_write_cmos_sensor(0x87,0x50);
	SP0A19_write_cmos_sensor(0x88,0x10);
	
	SP0A19_write_cmos_sensor(0x5a,0xff);
	SP0A19_write_cmos_sensor(0x5b,0xb0);
	SP0A19_write_cmos_sensor(0x5c,0x60);
	SP0A19_write_cmos_sensor(0x5d,0x10);
	...
	SP0A19_write_cmos_sensor(0xe8,0x48);
	SP0A19_write_cmos_sensor(0xec,0x54);
	
	SP0A19_write_cmos_sensor(0xe9,0x48);
	SP0A19_write_cmos_sensor(0xed,0x54);
	
	SP0A19_write_cmos_sensor(0xea,0x38);
	SP0A19_write_cmos_sensor(0xef,0x40);
	
	SP0A19_write_cmos_sensor(0xeb,0x2c);
	SP0A19_write_cmos_sensor(0xf0,0x30);
	
	//CCM
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0xa0,0x80);//0x80    92
	SP0A19_write_cmos_sensor(0xa1,0xf4);//0x0     fe
	SP0A19_write_cmos_sensor(0xa2,0x0c);//0x00    f1
	SP0A19_write_cmos_sensor(0xa3,0xf3);//0xf3    05
	SP0A19_write_cmos_sensor(0xa4,0x8e);//0x8e    80
	SP0A19_write_cmos_sensor(0xa5,0x00);//0x0     fa
	SP0A19_write_cmos_sensor(0xa6,0xe6);//0x0     13
	SP0A19_write_cmos_sensor(0xa7,0x00);//0xe6    bf
	SP0A19_write_cmos_sensor(0xa8,0x9a);//0x9a    ae
	SP0A19_write_cmos_sensor(0xa9,0x0c);//0x0     3c
	SP0A19_write_cmos_sensor(0xaa,0x03);//0x3     30
	SP0A19_write_cmos_sensor(0xab,0x03);//0xc     0c
	SP0A19_write_cmos_sensor(0xfd,0x00);
	...
	//rpc
	SP0A19_write_cmos_sensor(0xfd,0x00); 
	SP0A19_write_cmos_sensor(0xe0,0x44);
	SP0A19_write_cmos_sensor(0xe1,0x36);
	SP0A19_write_cmos_sensor(0xe2,0x2e);
	SP0A19_write_cmos_sensor(0xe3,0x2a);
	SP0A19_write_cmos_sensor(0xe4,0x2a);
	SP0A19_write_cmos_sensor(0xe5,0x28);
	SP0A19_write_cmos_sensor(0xe6,0x28);
	SP0A19_write_cmos_sensor(0xe8,0x26);
	SP0A19_write_cmos_sensor(0xe9,0x26);
	SP0A19_write_cmos_sensor(0xea,0x26);
	SP0A19_write_cmos_sensor(0xeb,0x24);
	SP0A19_write_cmos_sensor(0xf5,0x24);
	SP0A19_write_cmos_sensor(0xf6,0x24);
	
	//ae min gain  
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0x94,0x80);	//rpc_max_indr
	SP0A19_write_cmos_sensor(0x95,0x28);	 // 1e rpc_min_indr 
	SP0A19_write_cmos_sensor(0x9c,0x80);	//rpc_max_outdr
	SP0A19_write_cmos_sensor(0x9d,0x28);	//rpc_min_outdr  
	//ae target
	SP0A19_write_cmos_sensor(0xfd,0x00);
	SP0A19_write_cmos_sensor(0xed,0x94);
	SP0A19_write_cmos_sensor(0xf7,0x90);
	SP0A19_write_cmos_sensor(0xf8,0x88);
	SP0A19_write_cmos_sensor(0xec,0x84);
	...
	//lowlight lum
	SP0A19_write_cmos_sensor(0xfd,0x00); //
	SP0A19_write_cmos_sensor(0xb2,0x1c); //lum_limit	// 0x10
	SP0A19_write_cmos_sensor(0xb3,0x1f); //lum_set
	SP0A19_write_cmos_sensor(0xb4,0x50);
	SP0A19_write_cmos_sensor(0xb5,0x67);
	...
	SP0A19_write_cmos_sensor(0xd4,0x80); //0x78
	SP0A19_write_cmos_sensor(0xd6,0x70); //0x78
	SP0A19_write_cmos_sensor(0xd7,0x70);
...

{
	...
	SP0A19SetMirror(IMAGE_HV_MIRROR);
...
void SP0A19_set_saturation(UINT16 para)
{
    switch (para)
    {
        ...
        case ISP_SAT_HIGH:
			SP0A19_write_cmos_sensor(0xd3,SP0A19_P0_0xd3+0x20); //outdoor 
			SP0A19_write_cmos_sensor(0xd4,SP0A19_P0_0xd4+0x20); //normal 
			SP0A19_write_cmos_sensor(0xd6,SP0A19_P0_0xd6+0x20); //dummy
			SP0A19_write_cmos_sensor(0xd7,SP0A19_P0_0xd7+0x20); //low light
             break;
			 
        case ISP_SAT_LOW:
			SP0A19_write_cmos_sensor(0xd3,SP0A19_P0_0xd3-0x20); 
			SP0A19_write_cmos_sensor(0xd4,SP0A19_P0_0xd4-0x20); 
			SP0A19_write_cmos_sensor(0xd6,SP0A19_P0_0xd6-0x20); 
			SP0A19_write_cmos_sensor(0xd7,SP0A19_P0_0xd7-0x20);
             break;
			 
        case ISP_SAT_MIDDLE:
        default:
			SP0A19_write_cmos_sensor(0xd3,SP0A19_P0_0xd3);
			SP0A19_write_cmos_sensor(0xd4,SP0A19_P0_0xd4); 
			SP0A19_write_cmos_sensor(0xd6,SP0A19_P0_0xd6); 
			SP0A19_write_cmos_sensor(0xd7,SP0A19_P0_0xd7);
             break;
    }
     return;
...
void SP0A19_set_contrast(UINT16 para)
{
	...
	switch (para)
	{
		...
		case ISP_CONTRAST_HIGH:
			SP0A19_write_cmos_sensor(0xd4,SP0A19_P0_0xdd+0x10); 
			SP0A19_write_cmos_sensor(0xd6,SP0A19_P0_0xde+0x20); 
			 break;
