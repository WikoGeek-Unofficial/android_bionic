...
void ptpod(struct work_struct *work)
{
	...
	switch (opp_num) {
	case 1: MET_PRINTK(PTPOD_FMT FMT1, PTPOD_VAL VAL1); break;
	case 2: MET_PRINTK(PTPOD_FMT FMT2, PTPOD_VAL VAL2); break;
	case 3: MET_PRINTK(PTPOD_FMT FMT3, PTPOD_VAL VAL3); break;
	case 4: MET_PRINTK(PTPOD_FMT FMT4, PTPOD_VAL VAL4); break;
	case 5: MET_PRINTK(PTPOD_FMT FMT5, PTPOD_VAL VAL5); break;
	case 6: MET_PRINTK(PTPOD_FMT FMT6, PTPOD_VAL VAL6); break;
	case 7: MET_PRINTK(PTPOD_FMT FMT7, PTPOD_VAL VAL7); break;
	case 8: MET_PRINTK(PTPOD_FMT FMT8, PTPOD_VAL VAL8); break;
	case 9: MET_PRINTK(PTPOD_FMT FMT9, PTPOD_VAL VAL9); break;
	default: break;
	}
}
