...
#undef CCCI_MSG_INF
#undef CCCI_DBG_MSG
#undef CCCI_DBG_COM_MSG
#define CCCI_RPC_MSG(inx, fmt, args...) printk("[ccci_rpc]" "(%d)"fmt , inx, ##args)
...
#define CCCI_DBG_MSG(idx, tag, fmt, args...)	printk(KERN_ERR "[ccci/" tag "] (%d)" fmt, (idx+1), ##args)
#define CCCI_DBG_COM_MSG(fmt, args...)		printk(KERN_ERR "[ccci/com] (0)" fmt, ##args)
#endif
